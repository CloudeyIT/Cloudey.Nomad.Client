# Cloudey.Nomad.Client - the C# library for the Nomad
...
```
nuget pack -Build -OutputDirectory out Cloudey.Nomad.Client.csproj
```
...
## Documentation for Models
 ...
 - [Model.ACLTokenRoleLink](docs/ACLTokenRoleLink.md)
 ...
 - [Model.ChangeScript](docs/ChangeScript.md)
 ...
 - [Model.VariableMetadata](docs/VariableMetadata.md)
