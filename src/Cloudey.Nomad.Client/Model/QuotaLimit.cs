...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class QuotaLimit : IEquatable<QuotaLimit>, IValidatableObject
    {
        ...
        /// <param name="variablesLimit">variablesLimit.</param>
        public QuotaLimit(byte[] hash = default(byte[]), string region = default(string), Resources regionLimit = default(Resources), int variablesLimit = default(int))
        {
            this.Hash = hash;
            this.Region = region;
        ...
        /// <summary>
        /// Gets or Sets VariablesLimit
        /// </summary>
        [DataMember(Name = "VariablesLimit", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VariablesLimit: ").Append(VariablesLimit).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(QuotaLimit input)
        {
            ...
            return 
                ...
                (
                    this.VariablesLimit == input.VariablesLimit ||
                    this.VariablesLimit.Equals(input.VariablesLimit)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VariablesLimit.GetHashCode();
                return hashCode;
            }
        }
