...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class ACLTokenListStub : IEquatable<ACLTokenListStub>, IValidatableObject
    {
        ...
        public ACLTokenListStub(string accessorID = default(string), int createIndex = default(int), DateTime createTime = default(DateTime), bool global = default(bool), int modifyIndex = default(int), string name = default(string), List<string> policies = default(List<string>), List<ACLTokenRoleLink> roles = default(List<ACLTokenRoleLink>), string type = default(string), DateTime expirationTime = default(DateTime))
        {
