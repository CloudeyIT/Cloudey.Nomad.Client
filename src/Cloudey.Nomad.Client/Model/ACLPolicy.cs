...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class ACLPolicy : IEquatable<ACLPolicy>, IValidatableObject
    {
        ...
        /// <param name="jobACL">jobACL.</param>
        /// <param name="modifyIndex">modifyIndex.</param>
        /// <param name="name">name.</param>
        /// <param name="rules">rules.</param>
        public ACLPolicy(int createIndex = default(int), string description = default(string), JobACL jobACL = default(JobACL), int modifyIndex = default(int), string name = default(string), string rules = default(string))
        {
        ...
        /// Gets or Sets JobACL
        /// </summary>
        [DataMember(Name = "JobACL", EmitDefaultValue = false)]
        public JobACL JobACL { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  JobACL: ").Append(JobACL).Append("\n");
        ...
        public bool Equals(ACLPolicy input)
        {
            ...
            return 
                ...
                (
                    this.JobACL == input.JobACL ||
                    (this.JobACL != null &&
                    this.JobACL.Equals(input.JobACL))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JobACL != null)
                {
                    hashCode = (hashCode * 59) + this.JobACL.GetHashCode();
                }
