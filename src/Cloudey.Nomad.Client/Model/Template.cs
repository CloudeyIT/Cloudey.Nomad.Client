...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class Template : IEquatable<Template>, IValidatableObject
    {
        ...
        /// <param name="changeScript">changeScript.</param>
        ...
        public Template(string changeMode = default(string), ChangeScript changeScript = default(ChangeScript), string changeSignal = default(string), string destPath = default(string), string embeddedTmpl = default(string), bool envvars = default(bool), int gid = default(int), string leftDelim = default(string), string perms = default(string), string rightDelim = default(string), string sourcePath = default(string), long splay = default(long), int uid = default(int), long vaultGrace = default(long), WaitConfig wait = default(WaitConfig))
        {
        ...
        /// <summary>
        /// Gets or Sets ChangeScript
        /// </summary>
        [DataMember(Name = "ChangeScript", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChangeScript: ").Append(ChangeScript).Append("\n");
        ...
        public bool Equals(Template input)
        {
            ...
            return 
                ...
                (
                    this.ChangeScript == input.ChangeScript ||
                    (this.ChangeScript != null &&
                    this.ChangeScript.Equals(input.ChangeScript))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChangeScript.GetHashCode();
                }
