...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class ConsulUpstream : IEquatable<ConsulUpstream>, IValidatableObject
    {
        ...
        /// <param name="destinationNamespace">destinationNamespace.</param>
        ...
        public ConsulUpstream(string datacenter = default(string), string destinationName = default(string), string destinationNamespace = default(string), string localBindAddress = default(string), int localBindPort = default(int), ConsulMeshGateway meshGateway = default(ConsulMeshGateway))
        {
        ...
        /// <summary>
        /// Gets or Sets DestinationNamespace
        /// </summary>
        [DataMember(Name = "DestinationNamespace", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DestinationNamespace: ").Append(DestinationNamespace).Append("\n");
        ...
        public bool Equals(ConsulUpstream input)
        {
            ...
            return 
                ...
                (
                    this.DestinationNamespace == input.DestinationNamespace ||
                    (this.DestinationNamespace != null &&
                    this.DestinationNamespace.Equals(input.DestinationNamespace))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DestinationNamespace != null)
                {
                    hashCode = (hashCode * 59) + this.DestinationNamespace.GetHashCode();
                }
