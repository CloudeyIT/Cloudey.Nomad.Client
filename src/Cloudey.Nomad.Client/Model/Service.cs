...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class Service : IEquatable<Service>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets TaggedAddresses
        /// </summary>
        [DataMember(Name = "TaggedAddresses", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TaggedAddresses: ").Append(TaggedAddresses).Append("\n");
        ...
        public bool Equals(Service input)
        {
            ...
            return 
                ...
                (
                    this.TaggedAddresses == input.TaggedAddresses ||
                    this.TaggedAddresses != null &&
                    input.TaggedAddresses != null &&
                    this.TaggedAddresses.SequenceEqual(input.TaggedAddresses)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.TaggedAddresses.GetHashCode();
                }
                if (this.Tags != null)
                {
