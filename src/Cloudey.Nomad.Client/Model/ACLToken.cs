...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class ACLToken : IEquatable<ACLToken>, IValidatableObject
    {
        ...
        /// <param name="expirationTTL">expirationTTL.</param>
        ...
        public ACLToken(string accessorID = default(string), int createIndex = default(int), DateTime createTime = default(DateTime), long expirationTTL = default(long), DateTime expirationTime = default(DateTime), bool global = default(bool), int modifyIndex = default(int), string name = default(string), List<string> policies = default(List<string>), List<ACLTokenRoleLink> roles = default(List<ACLTokenRoleLink>), string secretID = default(string), string type = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ExpirationTTL
        /// </summary>
        [DataMember(Name = "ExpirationTTL", EmitDefaultValue = false)]
        ...
        public List<ACLTokenRoleLink> Roles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExpirationTTL: ").Append(ExpirationTTL).Append("\n");
        ...
        public bool Equals(ACLToken input)
        {
            ...
            return 
                ...
                (
                    this.ExpirationTTL == input.ExpirationTTL ||
                    this.ExpirationTTL.Equals(input.ExpirationTTL)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ExpirationTTL.GetHashCode();
