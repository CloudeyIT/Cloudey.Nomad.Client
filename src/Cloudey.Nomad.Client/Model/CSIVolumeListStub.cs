...
namespace Cloudey.Nomad.Client.Model
{
    ...
    public partial class CSIVolumeListStub : IEquatable<CSIVolumeListStub>, IValidatableObject
    {
        ...
        /// <param name="currentReaders">currentReaders.</param>
        /// <param name="currentWriters">currentWriters.</param>
        ...
        /// <summary>
        /// Gets or Sets CurrentReaders
        /// </summary>
        [DataMember(Name = "CurrentReaders", EmitDefaultValue = false)]
        public int CurrentReaders { get; set; }

        /// <summary>
        /// Gets or Sets CurrentWriters
        /// </summary>
        [DataMember(Name = "CurrentWriters", EmitDefaultValue = false)]
        public int CurrentWriters { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CurrentReaders: ").Append(CurrentReaders).Append("\n");
            sb.Append("  CurrentWriters: ").Append(CurrentWriters).Append("\n");
        ...
        public bool Equals(CSIVolumeListStub input)
        {
            ...
            return 
                ...
                (
                    this.CurrentReaders == input.CurrentReaders ||
                    this.CurrentReaders.Equals(input.CurrentReaders)
                ) && 
                (
                    this.CurrentWriters == input.CurrentWriters ||
                    this.CurrentWriters.Equals(input.CurrentWriters)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CurrentReaders.GetHashCode();
                hashCode = (hashCode * 59) + this.CurrentWriters.GetHashCode();
